...
database.ref("/players/").on("value", function(snapshot) {
	...
	if (snapshot.child("player1").exists()) {
		...
		$("#player1panel").removeClass("bg-warning");
		$("#player2panel").removeClass("bg-warning");
	...
	if (player1 && player2) {
		...
		$("#player1panel").addClass("bg-warning");

		// Update the center display
		$("#woutcome").html("Waiting on " + player1Name + " to choose...");
	}
...
database.ref("/turn/").on("value", function(snapshot) {
	...
	if (snapshot.val() === 1) {
		...
		if (player1 && player2) {
			$("#player1panel").removeClass("bg-warning");
			$("#player2panel").addClass("bg-warning");
			$("#woutcome").html("Waiting on " + player2Name + " to choose...");
		}
	}
});
...
$("#player1panel").on("click", ".selections", function(event) {
	event.preventDefault();
...
$("#player2panel").on("click", ".selections", function(event) {
	event.preventDefault();
